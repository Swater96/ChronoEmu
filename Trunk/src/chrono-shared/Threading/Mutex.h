...
public:
	 ...
	 */
	CHRONO_INLINE bool AttemptAcquire()
	{
#ifndef WIN32
...
public:
	CHRONO_INLINE FastMutex() : m_lock(0),m_recursiveCount(0) {}
	CHRONO_INLINE ~FastMutex() {}
