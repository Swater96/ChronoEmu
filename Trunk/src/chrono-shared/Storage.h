...
public:
	 ...
	 */
	CHRONO_INLINE T * Get() { return Pointer; }

	/** Sets the current object to P
	 */
	CHRONO_INLINE void Set(T * P) { Pointer = P; }

	/** Are we at the end of the storage container?
	 */
	CHRONO_INLINE bool AtEnd() { return (Pointer == 0); }
...
public:
	...
	CHRONO_INLINE char * GetIndexName() { return _indexName; }
	CHRONO_INLINE char * GetFormatString() { return _formatString; }
...
public:
	 ...
	 */
	CHRONO_INLINE void LoadBlock(Field * fields, T * Allocated)
	{
