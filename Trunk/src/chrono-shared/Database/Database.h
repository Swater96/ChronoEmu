...
public:
	...
	void Perform();
	CHRONO_INLINE void SetDB(Database * dbb) { db = dbb; }
};
...
public:
	...
	CHRONO_INLINE const string& GetHostName() { return mHostname; }
	CHRONO_INLINE const string& GetDatabaseName() { return mDatabaseName; }
	CHRONO_INLINE const uint32 GetQueueSize() { return queries_queue.get_size(); }
...
public:
	...
	CHRONO_INLINE Field* Fetch() { return mCurrentRow; }
	CHRONO_INLINE uint32 GetFieldCount() const { return mFieldCount; }
	CHRONO_INLINE uint32 GetRowCount() const { return mRowCount; }
