...
public:
	...
	CHRONO_INLINE size_t GetCount() { return AccountDatabase.size(); }
...
public:
	CHRONO_INLINE Mutex & getServerSocketLock() { return serverSocketLock; }
	CHRONO_INLINE Mutex & getRealmLock() { return realmLock; }
	...
	CHRONO_INLINE void   AddServerSocket(LogonCommServerSocket * sock) { serverSocketLock.Acquire(); m_serverSockets.insert( sock ); serverSocketLock.Release(); }
	CHRONO_INLINE void   RemoveServerSocket(LogonCommServerSocket * sock) { serverSocketLock.Acquire(); m_serverSockets.erase( sock ); serverSocketLock.Release(); }
