...
enum AreaTriggerFailures
{
	...
	AREA_TRIGGER_FAILURE_NO_RAID		= 2,
	AREA_TRIGGER_FAILURE_NO_ATTUNE_Q	= 3,
	AREA_TRIGGER_FAILURE_NO_ATTUNE_I	= 4,
	AREA_TRIGGER_FAILURE_LEVEL			= 5,
	AREA_TRIGGER_FAILURE_NO_GROUP		= 6,
	AREA_TRIGGER_FAILURE_NO_KEY         = 7,
};
