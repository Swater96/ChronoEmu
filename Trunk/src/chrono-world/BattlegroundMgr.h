...
public:
	...
	// Conversion for Types -> Map and Map -> Type for 1.12.x values
	uint32 GetBattleGroundMapIdByType(uint32 BattleGroundType)
	{
		...
		case BATTLEGROUND_ALTERAC_VALLEY: //Alterac Valley
			return 30;
			break;
		case BATTLEGROUND_WARSONG_GULCH: //Warsong Gulch
			return 489;
			break;
...
protected:
	/** World States, we can handle 
	   battleground worldstates in the 
...
public:
	...
	CHRONO_INLINE uint32 GetLevelGroup() { return m_levelGroup; }
	CHRONO_INLINE MapMgr* GetMapMgr() { return m_mapMgr; }
	...
	/* Has it ended? */
	CHRONO_INLINE bool HasEnded() { return m_ended; }
	CHRONO_INLINE bool HasStarted() { return m_started; }
	...
	/* Full? */
	CHRONO_INLINE bool IsFull() { return !(HasFreeSlots(0) || HasFreeSlots(1)); }
	...
	CHRONO_INLINE uint32 GetStartTime() { return m_startTime; }
	CHRONO_INLINE uint32 GetType() { return m_type; }
	...
	CHRONO_INLINE uint32 GetLastResurrect() { return m_lastResurrect; }
