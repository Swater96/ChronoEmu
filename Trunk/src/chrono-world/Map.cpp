		...
		if(result)
		{
			if(CheckResultLengthCreatures( result) )
			{
				do{
					...
					cspawn->channel_spell = fields[14].GetUInt16();
					cspawn->channel_target_go = fields[15].GetUInt32();
					cspawn->channel_target_creature = fields[16].GetUInt32();
					cspawn->stand_state = fields[17].GetUInt16();
