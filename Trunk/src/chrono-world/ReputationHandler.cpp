...
CHRONO_INLINE void SetFlagAtWar(uint8 & flag)
{
...
CHRONO_INLINE void UnsetFlagAtWar(uint8 & flag)
{
	if(!(flag & FACTION_FLAG_AT_WAR))
		return;
...
CHRONO_INLINE void SetFlagVisible(uint8 & flag)
{
...
CHRONO_INLINE void UnsetFlagVisible(uint8 & flag)
{
	if(!(flag & FACTION_FLAG_VISIBLE))
		return;
...
CHRONO_INLINE bool AtWar(uint8 flag) { return (flag & FACTION_FLAG_AT_WAR) ? true : false; }
CHRONO_INLINE bool Visible(uint8 flag) { return (flag & FACTION_FLAG_VISIBLE) ? true : false; }

CHRONO_INLINE bool RankChanged(int32 Standing, int32 Change)
{
...
CHRONO_INLINE bool RankChangedFlat(int32 Standing, int32 NewStanding)
{
