 ...
 */
const char * gItemPrototypeFormat						= "uuussssuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuffuffuffuffuffuuuuuuuuuufuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuusuuuuuuuuuuuuuuuu";
const char * gCreatureNameFormat						= "ussuuuuuuuuuffcc";
const char * gGameObjectNameFormat						= "uuusuuuuuuuuuuuuuuuuuuuuuuuu";
const char * gCreatureProtoFormat						= "uuuuuuufuuuffuffuuuuuuuuuuuuuuuuuuffsuuuufffuuu";
...
const char * gWorldMapInfoFormat						= "uuuuufffusuuuuufuc";
	...
	if( result != nullptr )
	{
		...
		if(Config.MainConfig.GetBoolDefault("Server", "LoadAIAgents", true))
		{
			do
			{
				...
				{
					WorldDatabase.Query("DELETE FROM ai_agents where entry = '%u'", entry);
				}
