...
enum Opcodes {
	...
	CMSG_MEETINGSTONE_INFO							= 662,	//(0x0296) -- HandleMeetingStoneInfoOpcode in MiscHandler.cpp
...
enum NPCFlags {
//updated for 1.12.1
/*			Name						 Hex		Decimal			Bit		Comments  */
	UNIT_NPC_FLAG_NONE				= 0x00000000,	//0				01		
	UNIT_NPC_FLAG_GOSSIP			= 0x00000001,	//1				02		CMSG_GOSSIP_HELLO
	UNIT_NPC_FLAG_QUESTGIVER		= 0x00000002,	//2				03		CMSG_QUESTGIVER_HELLO
	UNIT_NPC_FLAG_VENDOR			= 0x00000004,	//4				04		CMSG_LIST_INVENTORY
	UNIT_NPC_FLAG_TAXIVENDOR		= 0x00000008,	//8				05		CMSG_TAXIQUERYAVAILABLENODES
	UNIT_NPC_FLAG_TRAINER			= 0x00000010,	//16			06		CMSG_TRAINER_LIST
	UNIT_NPC_FLAG_SPIRITHEALER		= 0x00000020,	//32			07		SPIRITHEALERSOMETHINGOROTHER
	UNIT_NPC_FLAG_SPIRITGUIDE		= 0x00000040,	//64			08		SPIRITGUIDESOMETHINGOROTHER
	UNIT_NPC_FLAG_INNKEEPER			= 0x00000080,	//128			09		CMSG_BINDER_ACTIVATE
	UNIT_NPC_FLAG_BANKER			= 0x00000100,	//256			10		CMSG_BANKER_ACTIVATE
    UNIT_NPC_FLAG_PETITIONER        = 0x00000200,   //512			11		CMSG_PETITION_SHOWLIST
	UNIT_NPC_FLAG_TABARDCHANGER		= 0x00000400,	//1024			12		UNKNOWN
	UNIT_NPC_FLAG_BATTLEFIELDPERSON	= 0x00000800,	//2048			13		CMSG_BATTLEMASTER_HELLO
	UNIT_NPC_FLAG_AUCTIONEER		= 0x00001000,	//4096			14		MSG_AUCTION_HELLO
	UNIT_NPC_FLAG_STABLEMASTER		= 0x00002000,	//8192			15		MSG_LIST_STABLED_PETS
	UNIT_NPC_FLAG_ARMORER			= 0x00004000,	//16384			16		CMSG_LIST_INVENTORY
};
