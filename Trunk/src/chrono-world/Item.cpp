...
void Item::ApplyEnchantmentBonus( uint32 Slot, bool Apply )
{
	...
	// SUPALOSA_: Not here
	uint32 ItemSlot = m_owner->GetItemInterface()->GetInventorySlotByGuid( GetGUID() ) * 12;
...
{	
	...
	for(uint32 Index = ITEM_FIELD_ENCHANTMENT_09; Index < ITEM_FIELD_ENCHANTMENT_20; Index += 3)
	{
