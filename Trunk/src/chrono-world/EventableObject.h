...
protected:
	...
	CHRONO_INLINE int32 event_GetCurrentInstanceId() { return m_event_Instanceid; }
...
public:
	...
	CHRONO_INLINE bool event_HasEvents() { return m_events.size() > 0 ? true : false; }
...
public:
	...
	CHRONO_INLINE uint32 GetInstanceID() { return mInstanceId; }
