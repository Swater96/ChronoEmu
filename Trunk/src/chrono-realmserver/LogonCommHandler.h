...
public:
	...
	CHRONO_INLINE uint32 GetRealmType() { return _realmType; }
	...
	CHRONO_INLINE WorldSocket* GetSocketByRequest(uint32 id)
	{
		pendingLock.Acquire();
	...
	CHRONO_INLINE Mutex & GetPendingLock() { return pendingLock; }		
};
